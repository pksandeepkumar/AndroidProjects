 ...
 */
package com.texus.malayalamshort.db;
...
import com.texus.malayalamshort.utility.LOG;
...
public class Databases extends SQLiteOpenHelper  {
	...
	public static final String DATABASE_NAME = "MalayalamShortDB.db";
...
//		query_create_tables.add(CommunityGeoFenceDtl.CREATE_TABE_QUERY);
...
//		tables.add(CommunityGeoFenceDtl.TABLE_NAME);
